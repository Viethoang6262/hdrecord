...
public class SettingActivity extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, androidx.preference.Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (key_video_encoder != null) {
            key_video_encoder.setOnPreferenceChangeListener((androidx.preference.Preference.OnPreferenceChangeListener) this);
        }
